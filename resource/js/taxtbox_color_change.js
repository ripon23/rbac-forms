...
<!-- color  -->
	...
	if(document.getElementById("bmi").value > 24 && document.getElementById("bmi").value < 30) {
		document.getElementById("bmi").style.background = '#FF0'; // Yellow
	}
	
	if(document.getElementById("bmi").value > 29 && document.getElementById("bmi").value < 35) {
