...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/dproject/resource/img/news/ediror'; // Relative to domain name
	//$config['img_path'] = '/resource/img/news/ediror'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	//$config['base_url'] = 'http://localhost/gramclean';
	//$config['upload_path'] = 'C:/wamp64/www/gramclean/resource/img/news/ediror';
	//$config['upload_path']='/home/gramweb/public_html/projects/gramclean/resource/img/news/ediror';
