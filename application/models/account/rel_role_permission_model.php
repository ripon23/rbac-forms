...
class Rel_role_permission_model extends CI_Model {
  ...
  function get()
  {
    return $this->db->get('apninv_a3m_rel_role_permission')->result();
  }
  ...
  function get_by_role_id($role_id)
  {
    ...
    $this->db->from('apninv_a3m_rel_role_permission');
    $this->db->join('apninv_a3m_acl_permission', 'apninv_a3m_rel_role_permission.permission_id = apninv_a3m_acl_permission.id');
    $this->db->where("apninv_a3m_rel_role_permission.role_id = $role_id AND apninv_a3m_acl_permission.suspendedon IS NULL");
  ...
  function get_by_permission_id($permission_id)
  {
    ...
    $this->db->from('apninv_a3m_rel_role_permission');
    $this->db->join('apninv_a3m_acl_role', 'apninv_a3m_rel_role_permission.role_id = apninv_a3m_acl_role.id');
    $this->db->where("apninv_a3m_rel_role_permission.permission_id = $permission_id AND apninv_a3m_acl_role.suspendedon IS NULL");
  ...
  function update($role_id, $permission_id)
  {
    ...
    {
      $this->db->insert('apninv_a3m_rel_role_permission', array('role_id' => $role_id, 'permission_id' => $permission_id));
    }
  }
  ...
  function update_batch($role_id, $permission_ids)
  {
    ...
    if( count($permission_ids) > 0)
    {
      ...
      $this->db->insert_batch('apninv_a3m_rel_role_permission', $batch);
    }
  }
  ...
  {
    $this->db->delete('apninv_a3m_rel_role_permission', array('role_id' => $role_id, 'permission_id' => $permission_id));
  }
  ...
  {
    $this->db->delete('apninv_a3m_rel_role_permission', array('role_id' => $role_id));
  }
  ...
  {
    $this->db->delete('apninv_a3m_rel_role_permission', array('permission_id' => $permission_id));
  }
}