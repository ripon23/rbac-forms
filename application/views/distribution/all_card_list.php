...
<legend class="text-center"><?=lang('card_list')?></legend>  
<form class="form-horizontal" role="form" id="create-site-form"  name="create-site-form" action="./distribution/distribution/all_card_list_search/" method="post">
    <div class="col-md-12">
...
<div class="row">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
            <?php
			if($card->distributor_or_dealer=='di')
			{
			$distributor_info=$this->site_model->get_distributor_delear_info_by_id($card->distributor_dealer_id,'di');
			echo $distributor_info->distributor_name." (".$distributor_info->distributor_code.")";
			}
			?>
            </td>
            <td>
            <?php
			if($card->distributor_or_dealer=='de')
			{
			$delear_info=$this->site_model->get_distributor_delear_info_by_id($card->distributor_dealer_id,'de');
			echo $delear_info->dealer_name." (".$delear_info->dealer_code.")";
			}
			?>
            </td>                              
        </tr>
