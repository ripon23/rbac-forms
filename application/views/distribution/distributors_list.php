...
<form class="form-horizontal" role="form" id="create-site-form"  name="create-site-form" action="./distribution/distribution/distributors_list_search" method="post">
    <div class="col-md-12">
...
<div class="row">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
            <!-- Distribute Button -->
			<?php if ($this->authorization->is_permitted('can_distribute_card_among_distributors')) : ?> 
            <a href="<?php echo base_url().'distribution/distribution/distribute_to_distributor/'.$distributors->distributor_id;?>" class="btn btn-warning btn-xs"><?=lang('menu_distribute')?></a>
            <?php endif; ?>
            
            <!-- View card list Button -->
			<?php if ($this->authorization->is_permitted('can_view_prepaid_card_list')) : ?> 
            <a href="<?php echo base_url().'distribution/distribution/distributor_card_list/'.$distributors->distributor_id;?>" class="btn btn-info btn-xs"><?=lang('action_view')?> <?=lang('card_list')?></a>
            <?php endif; ?>
