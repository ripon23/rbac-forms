...
<legend class="text-center"><?=lang('card_list')?>: <?php echo $dealer_info->dealer_name." (".$dealer_info->dealer_code.")";?></legend>  
<form class="form-horizontal" role="form" id="create-site-form"  name="create-site-form" action="./distribution/distribution/dealer_card_list_search/<?=$dealer_info->dealer_id?>" method="post">
    <div class="col-md-12">
