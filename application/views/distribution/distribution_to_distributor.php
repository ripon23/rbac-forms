...
<head>
	...
	function confirm_distribution(card_serial_from,card_serial_to,card_type,distributor_id)
	{
	...
	$.ajax({ //Process the form using $.ajax()
					...
					url       : 'distribution/distribution/save_distribution', //Your form processing file URL
					beforeSend: function() {
...
<legend class="text-center"><?=lang('menu_distribution')?>: <?php echo $distributor_info->distributor_name." (".$distributor_info->distributor_code.")";?></legend>  
...
<div class="row">
    ...
    <div class="col-md-8">
		...
		{
		echo '<button id="btnconfirm" onClick="confirm_distribution('.$card_serial_from.','.$card_serial_to.','.$card_type.','.$distributor_info->distributor_id.')" name="btnconfirm" class="btn btn-warning btn-xs">'.lang('action_distribute_now').'</button>';
		}
        //echo "<pre>";
        //print_r($card_info);
        //echo "</pre>";
