...
<meta name="description" content="Aponjon Prepaid Card Inventory System">
<meta name="author" content="Zahidul Hossein Ripon (riponmailbox@gmail.com)">

<base href="<?php echo base_url(); ?>"/>

<link rel="shortcut icon" href="<?php echo base_url(); ?>favicon.ico"/>
<link type="text/css" rel="stylesheet" href="<?php echo base_url().RES_DIR; ?>/dist/css/bootstrap.min.css"/>
<link type="text/css" rel="stylesheet" href="<?php echo base_url().RES_DIR; ?>/dist/css/bootstrap-theme.min.css"/>
...
<script src="<?php echo base_url().RES_DIR; ?>/dist/js/bootstrap.min.js"></script>
