...
<ol class="breadcrumb">
  ...
  <li class="active"><?=lang('menu_dealers_management')?></li>
</ol>
...
<div class="col-md-12">
   ...
   <fieldset>
    <legend class="text-center"><?=lang('menu_dealers_management')?> </legend>
            ...
            <div class="form-group">            	
              	<label class="col-md-3 control-label" for="username"><?=lang('distributor_name')?></label>
              	<div class="col-md-6"> 
           	 	<?php echo '<span class="label label-default">'.$distributor_info->distributor_name." (".$distributor_info->distributor_code.")</span>";?>
            	</div>
            </div>
            
            
            <!-- dealer username input-->            
            <div class="form-group <?php echo (form_error('username')) ? 'has-error' : ''; ?>">            	
              <label class="col-md-3 control-label" for="username"><?=lang('username')?> *</label>
              <div class="col-md-6">              	 
                <input id="username" name="username" type="text" placeholder="<?=lang('username')?>" class="form-control" value="<?=$dealer_code?>" readonly>
            ...
            <div class="form-group <?php echo (form_error('dealer_name')) ? 'has-error' : ''; ?>">            	
              ...
              <div class="col-md-6">              	 
                <input id="dealer_name" name="dealer_name" type="text" value="<?php if(isset($dealer_name)) {echo $dealer_name;} ?>" placeholder="<?=lang('dealer_name')?>" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('dealer_code')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
                <input id="dealer_code" name="dealer_code" type="text" value="<?php if(isset($dealer_code)) {echo $dealer_code;} ?>" placeholder="<?=lang('dealer_code')?>" class="form-control" readonly>
            ...
            <div class="form-group <?php echo (form_error('dealer_mobile')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
                <input id="dealer_mobile" name="dealer_mobile" value="<?php if(isset($dealer_mobile)) {echo $dealer_mobile;} ?>" type="text" placeholder="01XXXXXXXXX" class="form-control">
