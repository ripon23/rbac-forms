...
<div class="row">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
            <!-- Edit Button -->
			<?php if ($this->authorization->is_permitted('can_create_own_dealer')) : ?> 
            <a href="<?php echo base_url().'distributors/distributors/edit_single_dealer_of_distributor/'.$dealers->dealer_id;?>" class="btn btn-warning btn-xs"><?=lang('action_edit')?></a>
            <?php endif; ?>                        
            </td>                       
        </tr>
        <?php 			
