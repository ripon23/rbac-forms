...
<form class="form-horizontal" role="form" id="create-site-form"  name="create-site-form" action="./distributors/distributors/dealers_list_search/<?=$distributor_info->distributor_id?>" method="post">
    <div class="col-md-12">
...
<div class="row">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <a href="<?php echo base_url().'distributors/distributors/edit_single_dealer/'.$dealers->dealer_id;?>" class="btn btn-warning btn-xs"><?=lang('action_edit')?></a>
            <?php endif; ?>                        
            </td>                       
        </tr>
        <?php 			
