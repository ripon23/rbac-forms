   ...
   <fieldset>
    <legend class="text-center"><?=lang('menu_create_distributors')?> </legend>
            ...
            <div class="form-group <?php echo (form_error('distributor_code')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
                <input id="distributor_code" name="distributor_code" type="text" value="<?php echo $distributor_info->distributor_code; ?>" placeholder="<?=lang('distributor_code')?>" class="form-control" readonly>
            ...
            <div class="form-group <?php echo (form_error('distributor_name')) ? 'has-error' : ''; ?>">            	
              ...
              <div class="col-md-6">              	 
                <input id="distributor_name" name="distributor_name" type="text" value="<?php echo $distributor_info->distributor_name; ?>" placeholder="<?=lang('distributor_name')?>" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('distributor_mobile')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
                <input id="distributor_mobile" name="distributor_mobile" value="<?php echo $distributor_info->distributor_mobile; ?>" type="text" placeholder="01XXXXXXXXX" class="form-control">
            ...
            <div class="form-group <?php echo (form_error('site_division')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
                <select name="site_division" id="site_division" class="form-control">
            		...
            		<option value="<?php echo $division->division; ?>" <?php if($division->division==$distributor_info->distributor_division) echo ' selected="selected"'; ?>><?php echo $division->loc_name_en?></option>
					<?php endforeach; ?>
       			</select>
            ...
            <div class="form-group <?php echo (form_error('site_district')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
               <?php 
				if($distributor_info->distributor_division)
				$district_list=$this->ref_location_model->get_location_list_by_id($distributor_info->distributor_division,NULL,NULL,NULL,NULL,NULL,'DT'); ?>
            <select name="site_district" id="site_district" class="form-control">
          		<?php 
				if($distributor_info->distributor_division)
				{
				foreach ($district_list as $district) : ?>
            	<option value="<?php echo $district->district; ?>" <?php if($district->district==$distributor_info->distributor_district) echo ' selected="selected"'; ?>><?php echo $district->loc_name_en?></option>
				<?php endforeach; 
				}
				?>
        	</select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <?php 
				if($distributor_info->distributor_district)
				$upazila_list=$this->ref_location_model->get_location_list_by_id($distributor_info->distributor_division,$distributor_info->distributor_district,NULL,NULL,NULL,NULL,'UP'); ?>
				<select name="site_upazila" id="site_upazila" class="form-control">
					<?php foreach ($upazila_list as $upazila) : ?>
					<option value="<?php echo $upazila->upazila; ?>" <?php if($upazila->upazila==$distributor_info->distributor_upazila) echo ' selected="selected"'; ?>><?php echo $upazila->loc_name_en?></option>
					<?php endforeach; ?>                             
				</select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                <?php 
				if($distributor_info->distributor_upazila)
				$union_list=$this->ref_location_model->get_location_list_by_id($distributor_info->distributor_division,$distributor_info->distributor_district,$distributor_info->distributor_upazila,NULL,NULL,NULL,'UN'); ?>
				<select name="site_union" id="site_union" class="form-control">
					<?php foreach ($union_list as $union) : ?>
					<option value="<?php echo $union->unionid; ?>" <?php if($union->unionid==$distributor_info->distributor_union) echo ' selected="selected"'; ?>><?php echo $union->loc_name_en?></option>
					<?php endforeach; ?>                           
				</select>
              </div>
            </div>
            ...
            <div class="form-group <?php echo (form_error('active_status')) ? 'has-error' : ''; ?>">
              ...
              <div class="col-md-6">
                <select name="active_status" id="active_status" class="form-control">
          			<option value=""><?php echo '--'.lang('select').'--'; ?></option>            
            		<option value="active" <?php if($distributor_info->active_status==1) echo ' selected="selected"'; ?>><?php echo lang('active')?></option>
                    <option value="inactive" <?php if($distributor_info->active_status==0) echo ' selected="selected"'; ?>><?php echo lang('inactive')?></option>						
       			</select>
