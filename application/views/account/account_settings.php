...
<div class="well"><?php echo lang('settings_privacy_statement'); ?></div>

<div class="col-md-5">

<?php echo form_open(uri_string(), 'class="class="form-horizontal"',  'role="form"'); ?>
...
<div class="form-group <?php echo (form_error('settings_email') || isset($settings_email_error)) ? 'error' : ''; ?>">
    ...
    <div class="controls">
		<?php echo form_input(array('name' => 'settings_email', 'id' => 'settings_email', 'class'=>'form-control', 'value' => set_value('settings_email') ? set_value('settings_email') : (isset($account->email) ? $account->email : ''), 'maxlength' => 160)); ?>
...
<div class="form-group <?php echo (form_error('settings_fullname')) ? 'error' : ''; ?>">
...
<div class="form-group <?php echo (form_error('settings_postalcode')) ? 'error' : ''; ?>">
